...
export const isCheckingAmounts = (consumedAmount: number, allowedAmount: number) => {
  return (consumedAmount === 0 || consumedAmount === undefined) && allowedAmount === 0
}

// calculate the progress of the consumed amount
export const calculatedProgress = (consumedAmount: number, allowedAmount: number) => {
...
export const availableAmount = (consumedAmount: number, allowedAmount: number) => {
...
export const displayConsumedAmount = (consumedAmount: number, allowedAmount: number) => {
...
export const displayAllowedAmount = (consumedAmount: number, allowedAmount: number) => {
